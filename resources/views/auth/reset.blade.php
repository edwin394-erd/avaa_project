...
<div class="h-screen flex flex-col items-center justify-center py-10 w-full ">
    <div class="mb-10 bg-white dark:bg-slate-900 shadow-green-900 shadow-2xl rounded-lg px-8 xl:px-20 py-6 w-full sm:w-2/3 lg:w-1/3 xl:1/4 mx-3 mt-0 md:mt-20 -translate-y-10">
        <img src="{{ asset('imgs/avaalogo_color.png') }}" class="w-40 mx-auto mb-4" alt="avaa Logo" />
        <h1 class="text-gray-700 dark:text-gray-100 text-md xl:text-xl font-bold text-center mb-2 ">Restablecer Contraseña</h1> <br>
        ...
        <form action="{{ route('password.update') }}" method="POST" novalidate>
            ...
            <div class="relative z-0 w-full mb-5 group">
                <input type="email" name="email" id="reset_email"
                    class="block py-2.5 px-0 w-full text-sm text-gray-900 dark:text-gray-100 bg-transparent border-0 border-b-2 border-gray-300 dark:border-slate-600 appearance-none focus:outline-none focus:ring-0 focus:border-green-600 dark:focus:border-green-400 peer @error('email') border-red-500 @enderror"
            ...
            <div class="relative z-0 w-full mb-5 group">
                <input type="password" name="password" id="reset_password"
                    class="block py-2.5 px-0 w-full text-sm text-gray-900 dark:text-gray-100 bg-transparent border-0 border-b-2 border-gray-300 dark:border-slate-600 appearance-none focus:outline-none focus:ring-0 focus:border-green-600 dark:focus:border-green-400 peer @error('password') border-red-500 @enderror"
                    placeholder=" " required autocomplete="new-password" />
                <label for="reset_password"
                    class="peer-focus:font-medium absolute text-sm text-gray-500 dark:text-gray-300 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:text-green-600 dark:peer-focus:text-green-400 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6">
                    Nueva contraseña
                </label>
                <button type="button" onclick="togglePassword('reset_password', this)" class="absolute right-2 top-3 bg-transparent px-2 py-1 text-gray-500 dark:text-gray-300 hover:text-gray-700 dark:hover:text-gray-100 focus:outline-none">
            ...
            <div class="relative z-0 w-full mb-5 group">
                <input type="password" name="password_confirmation" id="reset_password_confirmation"
                    class="block py-2.5 px-0 w-full text-sm text-gray-900 dark:text-gray-100 bg-transparent border-0 border-b-2 border-gray-300 dark:border-slate-600 appearance-none focus:outline-none focus:ring-0 focus:border-green-600 dark:focus:border-green-400 peer"
                    placeholder=" " required autocomplete="new-password" />
                <label for="reset_password_confirmation"
                    class="peer-focus:font-medium absolute text-sm text-gray-500 dark:text-gray-300 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:text-green-600 dark:peer-focus:text-green-400 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6">
                    Confirmar contraseña
                </label>
                <button type="button" onclick="togglePassword('reset_password_confirmation', this)" class="absolute right-2 top-3 bg-transparent px-2 py-1 text-gray-500 dark:text-gray-300 hover:text-gray-700 dark:hover:text-gray-100 focus:outline-none">
                    <span class="icon-show">
                        <!-- Ojo abierto -->
                        <svg width="20px" height="20px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M15.0007 12C15.0007 13.6569 13.6576 15 12.0007 15C10.3439 15 9.00073 13.6569 9.00073 12C9.00073 10.3431 10.3439 9 12.0007 9C13.6576 9 15.0007 10.3431 15.0007 12Z" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path> <path d="M12.0012 5C7.52354 5 3.73326 7.94288 2.45898 12C3.73324 16.0571 7.52354 19 12.0012 19C16.4788 19 20.2691 16.0571 21.5434 12C20.2691 7.94291 16.4788 5 12.0012 5Z" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path></svg>
                    </span>
                    <span class="icon-hide hidden">
                        <!-- Ojo tachado -->
