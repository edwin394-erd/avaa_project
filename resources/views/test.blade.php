...
@section('contenido')
<div class="flex">
    <div class="max-w-sm w-full bg-white rounded-lg shadow-sm dark:bg-gray-800 p-4 md:p-6  m-2">
        ...
        <div id="chart-legend" class="flex justify-center gap-4 mt-4">
            <span class="font-bold text-sm flex items-center">
                <span class="w-4 h-4 bg-[#31C48D] inline-block rounded-full mr-2"></span> Income
            </span>
            <span class="font-bold text-sm flex items-center">
                <span class="w-4 h-4 bg-[#F05252] inline-block rounded-full mr-2"></span> Expense
            </span>
        </div>
        <br><br>
