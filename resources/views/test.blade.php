    ...
    <div class="p-0 min-h-[650px]">
            ...
            <div class="flex items-center justify-center w-full">
                <div class="bg-white shadow-gray-200 border border-gray-300 shadow-2xl rounded-lg px-4 md:px-8 py-6 w-full sm:w-2/3 lg:w-2/3 xl:1/4  mx-3">
                    <h1 class="text-lg 2xl:text-2xl font-bold text-gray-800 text-center">Talleres</h1><br>
                    ...
                    <form action="{{ route('configuser.update') }}" method="POST" novalidate>
                        ...
                        <!-- Contraseña actual -->
                        <div class="mb-4">
                            <label for="password" class="block text-sm font-medium text-gray-700 mb-2">Meta</label>
                        <div class="relative flex items-center">
                                <input type="text" name="meta" id="meta" class="text-sm shadow-sm rounded-md w-full px-3 py-2 border-gray-300 focus:outline-none focus:ring-green-500 focus:border-green-500 @error('meta') border-red-700 @enderror" placeholder="Tu meta de talleres" required value="{{old('password')}}">
                                <button type="button" class="absolute right-2 bg-transparent px-2 py-1 text-gray-500 hover:text-gray-700 focus:outline-none">
