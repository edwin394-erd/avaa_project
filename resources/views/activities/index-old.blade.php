...
<div class="2xl:w-6/6 mx-auto py-5 px-0 md:px-5">
    ...
    <div id="contenedor-principal" class="flex flex-wrap min-h-[calc(90vh-4rem)] xl:flex-nowrap p-0 h-full">
        ...
        <div class="w-full xl:w-1/4 p-0 flex flex-col mb-4 xl:mb-0 order-1 xl:order-1 transition-all duration-500" id="formulario-izquierda">
            <div class="relative flex flex-col bg-white dark:bg-slate-900 border dark:border-gray-700 shadow-xl shadow-gray-100 dark:shadow-gray-900 rounded-l-xl p-4 h-full" id="form-content">
               ...
               <form action="{{ route('activities.store') }}" method="POST" novalidate class="flex flex-col flex-1" enctype="multipart/form-data">
    @csrf
    <div class="mb-2">
        <div class="flex">
    ...
    <div class="mb-2 flex flex-col md:flex-row md:space-x-2">
    ...
    <div class="mb-2 flex gap-2">
     ...
     <div class="w-full">
            <div class="flex">
                <label for="flyer" class="block text-sm font-medium text-gray-700 dark:text-gray-200 mb-2">Flyer (opcional)</label>
                @error('flyer')
                    <p class="block text-sm font-medium text-red-600 mb-2">- {{ $message }}</p>
                @enderror
            </div>
            <input type="file" name="flyer" accept="image/*,application/pdf"
                class="block w-full text-sm text-gray-900 dark:text-gray-100 border border-gray-300 dark:border-slate-700 rounded-md cursor-pointer bg-white dark:bg-slate-800 focus:outline-none focus:ring-slate-300 focus:border-slate-300 @error('flyer') border-red-700 @enderror">
        </div>
    <button type="submit"
